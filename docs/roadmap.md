...
- Next: rerun a disposable continuation check, then consider larger real Codex continuation dogfood if the one-item-at-a-time safety gates still hold
