...
- Next: dogfood `codex-worker-batch-run` on a disposable project; normal-PowerShell real Codex subprocess continuation remains separate and launcher/context gated
