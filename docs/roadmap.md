...
- Next: resolve the Codex subprocess write-access context or add a separately approved trusted patch-apply design/flow before retrying live real-code batch-run
