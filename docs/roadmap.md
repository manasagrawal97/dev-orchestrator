...
- Next: dogfood a valid unified diff proposal that passes non-mutating check before implementing any patch apply command or live real-code batch-run retry
