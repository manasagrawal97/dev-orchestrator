...
99. Next: dogfood reviewed patch apply on a disposable/synthetic patch flow before live code use.
100. Post-Phase-1 polish: artifact/index compaction, docs consolidation, prompt simplification, progress/read-model polish, UI polish, optional API/model agents, notifications, packaging, advanced UI, and other polish.
