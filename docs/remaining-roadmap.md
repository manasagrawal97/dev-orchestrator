...
83. Next: real Codex/batch dogfood should remain launcher-, context-, upstream-, and evidence-gated.
84. Post-Phase-1 polish: artifact/index compaction, docs consolidation, prompt simplification, progress/read-model polish, UI polish, optional API/model agents, notifications, packaging, advanced UI, and other polish.
