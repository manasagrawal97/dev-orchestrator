...
86. Next: TASK-DEVO-161 should polish stale retry/run selection and completed-queue next-action wording before larger real Codex continuation dogfood.
87. Post-Phase-1 polish: artifact/index compaction, docs consolidation, prompt simplification, progress/read-model polish, UI polish, optional API/model agents, notifications, packaging, advanced UI, and other polish.
