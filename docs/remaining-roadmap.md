...
97. Next: dogfood patch proposal show/check before any apply command or live code batch-run retry.
98. Post-Phase-1 polish: artifact/index compaction, docs consolidation, prompt simplification, progress/read-model polish, UI polish, optional API/model agents, notifications, packaging, advanced UI, and other polish.
