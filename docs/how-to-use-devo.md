...
The assisted queue-worker flow is dogfooded in `docs/dogfood/task-devo-132-queue-worker-assisted-e2e.md`, with the live three-task sandbox attempt recorded in `docs/dogfood/task-devo-136-live-three-task-assisted-dogfood.md`, the follow-up friction polish recorded in `docs/dogfood/task-devo-137-queue-worker-friction-polish.md`, the polished known-good delivery dogfood recorded in `docs/dogfood/task-devo-138-polished-assisted-known-good-delivery.md`, and the first fake-subprocess batch-run dogfood recorded in `docs/dogfood/task-devo-156-batch-run-fake-worker-dogfood.md`.
