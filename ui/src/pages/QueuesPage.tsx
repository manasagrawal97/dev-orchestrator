    ...
    <div className="task-detail">
      <KeyValueList
        items={[
          ...
          ['Selected item source', status.selected_item_source],
          ['Current task', status.current_task_id ?? 'none'],
          ['Source handoff', status.source_handoff_id ?? 'none'],
          ...
          ['Latest report status', status.latest_worker_report_status ?? 'none'],
